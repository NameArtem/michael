...
def proportion_test(c1:int, c2:int, n1:int, n2:int, mode:str = 'one_sided') -> Tuple[float,float]:
    '''
...
def proportion_plot(c1:int, c2:int, n1:int, n2:int, alpha:float=0.05, mode:str = 'one_sided') -> None:
    '''
