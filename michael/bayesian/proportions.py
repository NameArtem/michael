...
def sample_proportion(c:int,n:int,a:float=1,b:float=1,sim_size:int=100000) -> np.array: 
    '''
...
def proportion_test_b(c1:int,c2:int,n1:int,n2:int,
                      a1:float=1,a2:float=1,b1:float=1,b2:float=1,sim_size:int=100000) -> float:
    '''
...
def proportion_ratio(c1:int,c2:int,n1:int,n2:int,
                      a1:float=1,a2:float=1,b1:float=1,b2:float=1,sim_size:int=100000) -> float:
    '''
...
def proportion_diff(c1:int,c2:int,n1:int,n2:int,
                      a1:float=1,a2:float=1,b1:float=1,b2:float=1,sim_size:int=100000) -> float:
    '''
...
def proportion_plot_b(c1:int,c2:int,n1:int,n2:int,alpha:float=0.05,mode:str='ratio',
                      a1:float=1,a2:float=1,b1:float=1,b2:float=1,sim_size:int=100000) -> None:
    '''
...
def value_remaining(c_list:Collection[int], n_list:Collection[int], 
                    a_list:Collection[float], b_list:Collection[float],q:int=95,sim_size:int=100000) -> float:
    '''
